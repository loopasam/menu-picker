const FOODS = [
  { id: "cucumber", label: "Cucumber", icon: "assets/foods/cucumber.webp", group: "veggies" },
  { id: "green-beans", label: "Green beans", icon: "assets/foods/green-beans.webp", group: "veggies" },
  { id: "carrot", label: "Carrot", icon: "assets/foods/carrot.webp", group: "veggies" },
  { id: "broccoli", label: "Broccoli", icon: "assets/foods/broccoli.webp", group: "veggies" },
  { id: "peas", label: "Peas", icon: "assets/foods/peas.webp", group: "veggies" },
  { id: "edamame", label: "Edamame", icon: "assets/foods/edamame.webp", group: "veggies" },
  { id: "cherry-tomatoes", label: "Cherry tomatoes", icon: "assets/foods/cherry-tomatoes.webp", group: "veggies" },
  { id: "chicken", label: "Chicken", icon: "assets/foods/chicken.webp", group: "protein" },
  { id: "fish", label: "Fish", icon: "assets/foods/fish.webp", group: "protein" },
  { id: "egg", label: "Egg", icon: "assets/foods/egg.webp", group: "protein" },
  { id: "sausages", label: "Sausages", icon: "assets/foods/sausages.webp", group: "protein" },
  { id: "chicken-nuggets", label: "Chicken nuggets", icon: "assets/foods/chicken-nuggets.webp", group: "protein" },
  { id: "beef-patties", label: "Beef patties", icon: "assets/foods/beef-patties.webp", group: "protein" },
  { id: "fries", label: "Fries", icon: "assets/foods/fries.webp", group: "carbs" },
  { id: "pasta", label: "Pasta", icon: "assets/foods/pasta.webp", group: "carbs" },
  { id: "rice", label: "Rice", icon: "assets/foods/rice.webp", group: "carbs" },
  { id: "ebly", label: "Ebly", icon: "assets/foods/ebly.webp", group: "carbs" },
  { id: "couscous", label: "Couscous", icon: "assets/foods/couscous.webp", group: "carbs" },
  { id: "rosti", label: "Rösti", icon: "assets/foods/rosti.webp", group: "carbs" },
